    ...
    return (
        <SafeAreaView className="flex-1 bg-white py-5 px-5">
            <View className="flex-row items-center gap-5 mb-10">
                <BackBtn />
                <Text className="text-2xl">Password Manager</Text>
            </View>

            {hasPassword && <View className="mt-5  ">
                <Text className="text-lg font-500 font-medium">Cureent Password</Text>
                <TextInput
                    value={oldPassword}
            ...
            <View className="mt-5  ">
                <Text className="text-lg font-500 font-medium">New password</Text>
                <TextInput
                    value={password}
                    className="text-lg  bg-neutral h-14 rounded-xl px-3 mt-2"
                    secureTextEntry={true}
            ...
            <View className="mt-5">
                <Text className="text-lg font-500 font-medium">Confirm New Password</Text>
                <TextInput
            ...
            <Pressable onPress={hundelSubmit} className="mt-auto py-3 rounded-[40px] bg-black">
                {loading ? (
                    <ActivityIndicator color="#fff" size="small" />
                ) : (
                    <Text className="text-2xl font-medium font-500 tracking-wider text-center text-white">
                       {hasPassword ? "Update":"Add Password"}
                    </Text>
                )}
            </Pressable>
        </SafeAreaView>
