...
const Bar = (props: Props) => {
  ...
  return (
    <View className='w-full absolute bottom-0 bg-white left-0 right-0 py-3 flex-row '>
      ...
      {/* <Pressable onPress={() => router.push("/cart")} className='flex-1 items-center justify-center'>
        <View><ShoppingBasket size={27} strokeWidth={1.3} color={"#222"} />
        ...
        <Text  className="text-center w-full mt-1 text-xs text capitalize font-400">
          cart
        </Text>
      </Pressable> */}
    </View>
